...
```javascript
import triangular from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-triangular@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Triangular, cdf, entropy, kurtosis, logcdf, logpdf, mean, median, mgf, mode, pdf, quantile, skewness, stdev, variance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-triangular@v0.1.0-deno/mod.js';
```
